...
contained in $$$s$$$ three times. In other words, find any most frequent
two-gram.
...
Print the only line containing exactly two capital Latin letters — any
two-gram contained in the given string $$$s$$$ as a substring (i.e. two
...
def solve(s):
    ...
    for i in range(len(s) - 1):
        m[s[i:i+2]] += 1
    return next(k for k, v in m.items() if v == max(m.values()))
