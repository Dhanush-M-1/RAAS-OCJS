...
She is only beginning to count, so she can calculate a sum only if the summands follow in non-decreasing order. For example,
...
# s = str(input())
# l1 = [i for i in s if i =='1' or i =='2' or i =='3']
