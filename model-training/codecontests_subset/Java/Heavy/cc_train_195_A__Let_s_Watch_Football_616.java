...
public class A195{
  static class ProblemSolver{
    // static int upper_bound(int b, int k){
    //   int l=1, r=1000;//ar.length;
    ...
    //     if(mid*b > k) r=mid;
    //     else l=mid+1;
    //     // System.out.printf("r: %d, l: %d, mid: %d\n", r, l, mid);
    //   }
    //   return l;
    // }
    public void solveTheProblem(InputReader in,OutputWriter out, NumberTheory nt){
      ...
      while(test-- >0){
        ...
        int needed= a*c;
        int get= b*c;
        int needed_beforehand= needed-get;
        // int ub= upper_bound(seq, b, needed_beforehand);
        // int ub= upper_bound(b, needed_beforehand);
        // System.out.println(needed_beforehand+"  "+b);
        // System.out.println(needed_beforehand/b);
        System.out.println((int)Math.ceil((double)needed_beforehand/b));
      }
    }
  }
