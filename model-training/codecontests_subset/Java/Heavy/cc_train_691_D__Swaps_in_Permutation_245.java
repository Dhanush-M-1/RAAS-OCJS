...
public class Main {
    ...
    static class TaskD {
        public void solve(int testNumber, InputReader in, PrintWriter out) {
            ...
            Map<Integer, List<Integer>> compElems = new HashMap<>();
            for (int rt : comps) compElems.put(rt, new ArrayList<>());
            for (int i = 0; i < n; i++) {
                int rt = d.root(i);
            ...
            Random r = new Random();
            for (int rt : comps) {
                List<Integer> elems = compElems.get(rt);
                Collections.shuffle(elems, r);
