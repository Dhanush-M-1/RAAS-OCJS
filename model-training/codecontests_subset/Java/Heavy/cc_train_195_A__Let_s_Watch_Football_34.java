...
1.5 Take input in an Long Array - ob.sr_lin(n);
...
// Write Your Program in the main method below! 
  public static void main(String args[])throws Exception
  {
    ...
    System.out.println(ob.bsearch(a,b,c));
  }

  public int bsearch(int a, int b, int c)
  {
      football ob = new football();
      int l = 0;
      int h = a*c;
      ...
      {
          int mid = (l+h)/2;
          int res = ob.chkbuffer(a,b,c,mid);
          if(res==1)  
           h = mid-1;
          else
           l = mid+1;
  ...
  public int chkbuffer(int a,int b,int c,int data)
  {
      int str_buff = c*b;
      int watched = data+str_buff;
    if(watched<(a*c))
      return -1;
    else
     return 1;
  ...
  public long[] ar_lin(int n)throws Exception
