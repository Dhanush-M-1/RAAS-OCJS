...
public class Myclass {
        ...
        static boolean visit2[]=new boolean [300001];
        static int cost[]=new int[300001];
        ...
        public static void main(String[] args) 
        {
            ...
            else
            {
            	...
            	if(a[(int)n/2]<s)
            	{
            		for(int i=(int)n/2;i<n && a[i]<s;i++) {
            			cnt+=(s-a[i]);
            		}
            	}
            	else
            	{
            		for(int i=(int)n/2;i>=0 && a[i]>s;i--) {
            			cnt+=Math.abs(s-a[i]);
            		}
            	}
            	pw.println(cnt);
