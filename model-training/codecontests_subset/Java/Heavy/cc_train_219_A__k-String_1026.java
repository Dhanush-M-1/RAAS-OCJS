 ...
 * Discussion
 * ----------
 * Create a histogram of the input string. If freq[c] is the number
 * of times character c appears in the string, then each k-string
 * contains freq[c]/k copies of c. If freq[c] % k != 0, then it is not
 * possible to form a k-string.
 */
