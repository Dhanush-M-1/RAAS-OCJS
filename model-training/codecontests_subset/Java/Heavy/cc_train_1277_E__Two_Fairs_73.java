...
public class tr1 {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    while(t-->0) {
	    	...
	    	long ans=0;
	        TreeSet<Integer> []a1=new TreeSet[n];
	        TreeSet<Integer> []b1=new TreeSet[n];
	        for(int i=0;i<n;i++) {
	        	a1[i]=new TreeSet<>();
	        	b1[i]=new TreeSet<>();
	        }
	        ...
	        long bs=0;
	        for(int i=0;i<n;i++) {
	        	if(a1[i].size()==1 && a1[i].contains(a))
	        		as++;
	        	if(a1[i].size()==1 && a1[i].contains(b))
	        		bs++;
	        }
