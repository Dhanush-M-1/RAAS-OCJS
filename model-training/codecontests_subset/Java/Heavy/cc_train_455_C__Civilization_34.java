...
public class _455C {
    ...
    public static void main(String[] args) throws Exception {
        ...
        n = Reader.nextPositiveInt();
        m = Reader.nextPositiveInt();
        q = Reader.nextPositiveInt();
        father = new int[n];
        diameter = new int[n];
        next = new int[n];
        ...
        for (int i = 0; i < m; i++) {
            int u = Reader.nextPositiveInt() - 1;
            int v = Reader.nextPositiveInt() - 1;
            g[u].add(v);
            g[v].add(u);
            union(u, v);
        }
...
//            System.out.println(Arrays.toString(diameter));
            int type = Reader.nextPositiveInt();
            if (type == 1) {
                int x = Reader.nextPositiveInt() - 1;
