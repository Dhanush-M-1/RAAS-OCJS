...
//			Collections.reverse(l);  //Use to Sort decreasingly 
	...
	{
		int[] parent;
		int[] size; //Size of the trees is used as the rank
		public DSU(int n)
		{
			parent = new int[n];
			size = new int[n];
	...
	public static void main(String[] args) throws IOException 
	{
		...
		fout.println(first + " " + list.size());
		
		for(int x : list) fout.print(x + " ");
		fout.println();
