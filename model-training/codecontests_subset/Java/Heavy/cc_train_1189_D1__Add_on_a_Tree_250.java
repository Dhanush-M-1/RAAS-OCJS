	...
	import java.io.*;
			...
			{	
				...
				public static long fun(long n, long p)
				{
					long[][] f = {{3, 0, 0}, {6, -1, 2}, {0, 0, 1}};
					long[][] t = {{1}, {1}, {1}};
					
					f = matrixpower(f, (n-1)/2, p);
					t = matrixmultiply(f, t, p);
				...
				public static long[][] matrixpower(long[][] mat, long n, long p)
				{
					int r = mat.length;
					long[][] ans = new long[r][r];
					...
					{
						if(n%2 == 1)
							ans = matrixmultiply(ans, mat, p);
						mat = matrixmultiply(mat, mat, p);
						n /= 2;
					}
				...
				public static long[][] matrixmultiply(long[][] M1, long[][] M2, long p)
				{
					int m1 = M1.length, m2 = M2[0].length;
					long[][] ans = new long[m1][m2];
					...
					for(int i=0;i<m1;i++)
					{
						for(int j=0;j<m2;j++)
						{
							for(int k=0;k<M2.length;k++)
								ans[i][j] = (ans[i][j]%(p) + ((M1[i][k]%(p))*(M2[k][j]%(p)))%(p))%(p);
						}
				...
				public static long prime(long nth) {
				...
				public static int BinarySearch_l(long[] a, long k)
				{
					int n = a.length;
					int i = 0, j = n-1;
					int mid = 0;
				...
				public static int BinarySearch_r(long[] a, long k)
				{
					int n = a.length;
					int i = 0, j = n-1;
					int mid = 0;
