...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Point center = t.circumCircle();
        if (center == null) {
            out.println("No");
            out.flush();
            return;
        }
        double d1 = center.dist(a);
        double d2 = center.dist(b);
        double d3 = center.dist(c);
        double a1 = Point.angle(a, center, b);
        double a2 = Point.angle(b, center, c);
        if (d1 == d2 && d2 == d3 && a1 == a2) {
            out.println("Yes");
        } else out.println("NO");
        out.flush();
    }

    static Point findCenter(Point p1, Point p2, Point p3) {
