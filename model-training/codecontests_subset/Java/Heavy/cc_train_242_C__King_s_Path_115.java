...
public class Main{
    ...
    static class ChessBoardSquare
    {
        ...
        ChessBoardSquare(int distance,Long pred,Long x,Long y,Long pos)
        {
            ...
            while (q.size() != 0)
            {
                ...
                for (int i = 0; i < 8; i++)
                {
                    ...
                    if (!visited.contains(adjpos) && board.containsKey(adjpos)  && adjx >= 0 && adjx < 1000000000 && adjy >= 0 && adjy < 1000000000)
                    {
                        ...
                        adjBoard.pred = currentBoardSquare.pos;
                        q.add(adjBoard);
                        visited.add(adjpos);
                    }
                }
    ...
    public static void main(String args[])
    {
        ...
        for(int i=0;i<n;i++)
        {
            ...
            for(long j=xstart;j<=xend;j++)
            {
                ...
                board.put(pos,new ChessBoardSquare(-1,-1l,j-1,row-1,pos));
            }
        }
