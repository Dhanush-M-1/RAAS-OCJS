...
public class WeaknessAndPoorness {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; ++i) {
            a[i] = fs.nextInt();
            allTheSame = allTheSame && (i > 0? a[i] == a[i - 1]: true);
        }
        ...
        double l = -10 * 1001;
        double r = 10 * 1001 + new Random().nextInt(3000);
        ...
        while (true) {
            ...
            if (m1Weakness < m2Weakness) {
                r = m2;
            } else if (m1Weakness > m2Weakness) {
                l = m1;
            } else {
                System.out.println(m1Weakness);
                return;
            }

            if (Math.abs(m1Weakness - m2Weakness) < Math.pow(10, -15.)) {
                System.out.println(m1Weakness);
                return;
            }
        }
