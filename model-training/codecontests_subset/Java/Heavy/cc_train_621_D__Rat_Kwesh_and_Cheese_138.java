...
public class Main {
    ...
    static class TaskD {
        ...
        public static int cmp(Func a, Func b) {
            ...
            return MathUtils.equals(a.get(), b.get()) ? cmpIndex(a, b) : (MathUtils.sign(a.x - 1)) * Double.compare(a.get(), b.get());
        }
        ...
        public static int compare10(Func a, Func b) {
            ...
            if ((a.x - 1) * (b.x - 1) < 0) return Double.compare(a.x, b.x);
            return MathUtils.equals(a.get(), b.get()) ? cmpIndex(a, b) : (MathUtils.sign(a.x - 1)) * Double.compare(a.get(), b.get());
        /*if (a.x > 1) return MathUtils.equals(a.get(), b.get()) ? cmpIndex(a, b) : Double.compare(a.get(), b.get());
        return  MathUtils.equals(abs(a.get()), abs(b.get())) ? cmpIndex(a, b) : -Double.compare(a.superGet(), b.get());*/
        }
    ...
    static class Func {
        ...
        public double get() {
            return type == 0 ? llog() : superGet();
        }

        public double superGet() {
            return Math.log(Math.abs(Math.log(x))) + Math.log(y * z);
        }

        public double llog() {
            return Math.log(Math.abs(Math.log(x))) + z * Math.log(y);
        }
