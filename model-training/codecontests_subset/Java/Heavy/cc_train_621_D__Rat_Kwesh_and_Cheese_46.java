...
public class Main {
    ...
    static class TaskD {
        ...
        public static int compare00(Func a, Func b) {
            int test = cmpOne(a, b);
            if (test != 0) return test;
            if (a.x > 1) {
                if (b.x > 1) {
                    if (MathUtils.equals(Math.log(Math.log(a.x)) + a.z * Math.log(a.y), Math.log(Math.log(b.x)) + b.z * Math.log(b.y))) {
                        return cmpIndex(a, b);
                    } else {
                        return Double.compare(Math.log(Math.log(a.x)) + a.z * Math.log(a.y), Math.log(Math.log(b.x)) + b.z * Math.log(b.y));
                    }
                } else {
        ...
        public static int compare11(Func a, Func b) {
            int test = cmpOne(a, b);
            if (test != 0) return test;
            if (a.x > 1) {
                if (b.x < 1) {
                    ...
                    if (MathUtils.equals(Math.log(a.x) * a.y * a.z, Math.log(b.x) * b.y * b.z)) {
                        return cmpIndex(a, b);
                    } else {
                        return Double.compare(Math.log(a.x) * a.y * a.z, Math.log(b.x) * b.y * b.z);
                    }
                }
            } else {
                if (b.x > 1) {
        ...
        public static int compare01(Func a, Func b) {
            ...
            if (a.x > 1) {
                if (b.x > 1) {
                    if (MathUtils.equals(Math.log(Math.log(a.x)) + a.z * Math.log(a.y), Math.log(Math.log(b.x)) + Math.log(b.y * b.z))) {
                        return cmpIndex(a, b);
                    } else {
                        return Double.compare(Math.log(Math.log(a.x)) + a.z * Math.log(a.y), Math.log(Math.log(b.x)) + Math.log(b.y * b.z));
                    }
                } else {
                    return Double.compare(a.x, b.x);
                }
            ...
            if (a.x > 1) {
                if (b.x > 1) {
                    if (MathUtils.equals(Math.log(Math.log(b.x)) + Math.log(b.y * b.z), Math.log(Math.log(a.x)) + a.z * Math.log(a.y))) {
                        ...
                        double valueOfB = Math.log(Math.log(b.x)) + b.z * Math.log(b.y);
        ...
        public void solve(int testNumber, FastScanner in, FastPrinter out) {
            ...
            Comparator<Func> fuck = new Comparator<Func>() {
                ...
                public int compare(Func a, Func b) {
                    if (a.type == 1) {
                        return b.type == 1 ? compare11(a, b) : compare10(a, b);
                    } else {
                        return b.type == 1 ? compare01(a, b) : compare00(a, b);
                    }
                }
            };
            Func exe = funcs[0];
