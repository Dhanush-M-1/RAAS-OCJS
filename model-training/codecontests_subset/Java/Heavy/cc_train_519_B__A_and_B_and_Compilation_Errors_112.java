 ...
 * 
 * Input 
 * The first line of the input contains integer n (3 ≤ n ≤ 105) — the
 ...
 * 
 * Output 
 * Print two numbers on a single line: the numbers of the compilation
 * errors that disappeared after B made the first and the second correction,
 * respectively.
 * 
 * Sample test(s) 
 * input 
 ...
 * 
 * @Title: B519AandBandCompilationErrors.java
 * @author lxh
 * @date Sep 20, 2015 1:16:10 PM
 * 
 */
