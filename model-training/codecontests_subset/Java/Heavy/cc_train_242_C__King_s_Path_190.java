...
public class KingPath {
    ...
    static void Dijkstra(TreeSet<Point> graph,  Point source, Point destination) {
    ...
    public static void main(String[] args) {
        ...
        // TreeSet<Point> visitedPoint = new TreeSet<>();
        // visitedPoint.add(new Point(5,7));
        // Point point = new Point(5, 6);   
        // System.out.println(isValidPoint(graph, visitedPoint, point));
    }
}
