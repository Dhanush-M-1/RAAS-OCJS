    		    ...
    		    //	private static TreeSet<Integer> ts=new TreeSet[200000];
    		    	...
    		    	private static void soln2(){
    		    		...
    		    		int a=nextInt();
    		    		int b=nextInt();int c=nextInt();
    		    		int tot_data_req=c*a;
    		    		int low=0,high=(int)1e6,ans=0;
    		    		while(low<=high){
    		    			int mid=(low+high)/2;
    		    			int loaded=(mid*b);
    		    	...
    		    	private static boolean ifposs(int mid,String wr,String cr,int []a){
