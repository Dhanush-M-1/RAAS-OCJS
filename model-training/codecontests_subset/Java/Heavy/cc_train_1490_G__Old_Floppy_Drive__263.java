...
//				out.println(sumofone+" "+arr[n-1].index);
...
//					out.println("fuck "+idx+" "+input);
					out.print(another[idx]-1+" ");
				}
				else {
					long maxx = arr[n-1].value;
					if(arr[n-1].value>=input) {
						int idx = LowerBound(arr, input);
						out.print(another[idx]-1+" ");
						continue;
					}
					if(sumofone<=0) {
						int idx = LowerBound(arr, input);
//						out.print(input+" fuck");
						out.print(another[idx]-1+" ");
						continue;
					}
					long roundsreq = (long)(input-maxx+sumofone-1)/sumofone;
					long remains = input - roundsreq*sumofone;
					int idx = LowerBound(arr, (int)remains);
//					out.println("fuck "+remains+" "+idx+" "+roundsreq);
