...
//	static int mod = 998244353;
	...
	public static void main(String[] args) throws IOException {
		...
		HashSet<Integer>[] ok = new HashSet[n+1];
		for(int i = 0; i <= n; ++i) {
			ok[i] = new HashSet<>();
		}
		while(m --> 0) {
...
//		int time, lazy;
		...
		public Segment(char[] a, int l, int r) {
			super();
			if(l == r) {
				set.add(a[l]);
				return;
...
//			lazyPropagation();
		...
		HashSet<Character> querySet(int ll, int rr, int l, int r) {
			if(noIntersection(ll, rr, l, r))
				return new HashSet<>();
			if(covered(ll, rr, l, r))
				return this.set;
			int mid = (l + r) / 2;
			HashSet<Character> leftSet = left.querySet(ll, rr, l, mid);
			HashSet<Character> rightSet = right.querySet(ll, rr, mid+1, r);
...
//		int queryCnt(int ll, int rr, int x, int l, int r) {
//			if(noIntersection(ll, rr, l, r))
//				return 0;
//			if(covered(ll, rr, l, r)) {
//				if(this.gcd % x == 0)
...
//				}
//				int mid = (l + r) / 2;
//				if(left.gcd % x != 0 && right.gcd % x != 0) {
//					return 2;
//				}
//				if(left.gcd % x != 0) {
//					return left.queryCnt(ll, rr, x, l, mid);
//				}
//				return right.queryCnt(ll, rr, x, mid+1, r);
//			}
//			int mid = (l + r) / 2;
//			int leftCnt = left.queryCnt(ll, rr, x, l, mid);
//			int rightCnt = right.queryCnt(ll, rr, x, mid+1, r);
//			return leftCnt + rightCnt;
//		}
		
//		void update(int ll, int rr, int value, int l, int r) {
////			lazyPropagation();
//			if(noIntersection(ll, rr, l, r))
//				return;
//			if(covered(ll, rr, l, r)) {
...
//			}
//			int mid = (l + r) / 2;
//			left.update(ll, rr, value, l, mid);
//			right.update(ll, rr, value, mid+1, r);
