...
public class A {
    ...
    static void solve() throws Exception {
        long p1x = nextLong(), p1y = nextLong(), p2x = nextLong(), p2y = nextLong(), p3x = nextLong(), p3y = nextLong();
        if ((p1x - p2x)*(p2y - p3y) - (p2x - p3x)*(p1y - p2y) == 0 || dist(p1x,p1y,p2x,p2y) != dist(p3x,p3y,p2x,p2y)) out.println("No");
