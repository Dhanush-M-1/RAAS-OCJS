...
public class B_432
{
	...
	public static long distance2(long px, long py, long qx, long qy)
	{
		long x = qx - px;
		long y = qy - py;
		return x * x + y * y;
	...
	public static boolean onLine(long ax, long ay, long bx, long by, long cx, long cy)
	{
		return 2 * bx - ax == cx && 2 * by - ay == cy;
	}

	public static boolean onLineMirror(long ax, long ay, long bx, long by, long cx, long cy)
	{
		return onLine(ax, ay, bx, by, cx, cy) || onLine(bx, by, ax, ay, cx, cy);
	}

	public static boolean onLineMirrorPermutate(long ax, long ay, long bx, long by, long cx, long cy)
	{
		return onLineMirror(ax, ay, bx, by, cx, cy) || onLineMirror(bx, by, cx, cy, ax, ay) || onLineMirror(cx, cy, ax, ay, bx, by);
	}
	...
	public static void solve() throws IOException
	{
		...
		long cx = nextLong();
		long cy = nextLong();
		long ab2 = distance2(ax, ay, bx, by);
		long bc2 = distance2(bx, by, cx, cy);
		if (ab2 == bc2)
		{
			if (onLineMirrorPermutate(ax, ay, bx, by, cx, cy))
			{
				out.println("No");
			}
			else
