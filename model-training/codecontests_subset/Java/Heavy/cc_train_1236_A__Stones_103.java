...
class Solver {
    ...
    Solver() {
        hp = new Helper(Long.MAX_VALUE, MAXN);
    ...
    void solve() throws Exception {
        ...
        for (int tc = hp.nextInt(); tc > 0; --tc) {
            int a = hp.nextInt(), b = hp.nextInt(), c = hp.nextInt();
    ...
    BigInteger combination(long n,long r)
    {
        BigInteger com=fact(n).divide(fact(n-r).multiply(fact(r)));
        return com;
    }
    BigInteger fact(long n2)
    {
