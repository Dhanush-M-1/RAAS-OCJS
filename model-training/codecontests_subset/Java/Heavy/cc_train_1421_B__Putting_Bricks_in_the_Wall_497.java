...
public class TaskB {
    ...
    void main() throws IOException {
        ...
        while (T-- > 0) {
            ...
            if (a[0][1] == a[1][0]) {
                if (a[n - 1][n - 2] == a[0][1] && a[n - 2][n - 1] == a[0][1]) {
                    out.prln(2);
                    out.prln("1 2");
                    out.prln("2 1");
                }
                ...
                if (a[n - 1][n - 2] != a[n - 2][n - 1]) {
                    if (a[n - 1][n - 2] == a[0][1]) {
                        out.prln(1);
                        out.prln((n - 1 + 1) + " " + (n - 2 + 1));
                    } else if (a[n - 2][n - 1] == a[0][1]) {
                        out.prln(1);
                        out.prln((n - 2 + 1) + " " + (n - 1 + 1));
                    }
                }
            }
            ...
            if (a[0][1] != a[1][0]) {
                ...
                if (a[n - 1][n - 2] != a[n - 2][n - 1]) {
                    ...
                    if (a[n - 1][n - 2] == '1') {
                        count++;
                        sb.append((n - 1 + 1) + " " + (n - 2 + 1)).append("\n");
                    } else if(a[n - 2][n - 1] == '1'){
                        count++;
                        sb.append((n - 2 + 1) + " " + (n - 1 + 1)).append("\n");
                    }
                    out.prln(count);
                    out.prln(sb);
                }
    ...
    static class in {
        ...
        static String[][] rim(int n, int m) throws IOException {
