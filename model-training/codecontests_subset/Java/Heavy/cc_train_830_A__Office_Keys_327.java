...
public class Main {
    static Integer[] a = new Integer [1010];
    static Integer[] b = new Integer [2020];
    static long[][] dp = new long [1010][2020];
    public static void main(String args[]) {
        ...
        Arrays.sort(a, 1, n+1, new MyCom());
        Arrays.sort(b, 1, k+1, new MyCom());
        dp[0][0] = 0;
        for(int i=1; i<=n; i++) {
            for(int j=i; j<=k; j++) {
